    ...
    return (
        <div
            ...
            className={cn(
                ...
                "md:hidden",
                "flex flex-col justify-between gap-4 border-r border-primary/20 bg-background/95 backdrop-blur-xl",
                className
            )}
            ref={navContainerRef}
            {...props}
        >
            <div
                className="relative space-y-5 overflow-y-scroll pt-[4.5rem]"
            ...
            >
                ...
                <ul ref={navListRef} className="relative z-10 space-y-2 p-4">
                    {siteConfig.menu.map((item, index) => {
                        ...
                        return (
                            ...
                            >
                                <Link
                                    href={item.href}
                                    className="group flex items-center justify-between rounded-2xl border border-primary/20 bg-primary/5 p-4 transition-all duration-300 hover:border-primary/40 hover:bg-primary/10"
                                    target={
